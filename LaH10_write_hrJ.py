...
for j in range( 0 , lines ):
    ...
    H_R_complex_new[j] = H_R_complex_new[j] + special.jv(m_order, A_dot_d) * H_R_complex[j] #* e ** (1j * m_order * omega * time)
    H_R_complex_new0[j] = H_R_complex_new0[j] + special.jv(m0_order, A_dot_d) * H_R_complex[j] #* e ** (1j * m_order * omega * time)
